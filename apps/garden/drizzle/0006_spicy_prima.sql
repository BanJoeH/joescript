...
INSERT INTO `__new_household_members`("id", "household_id", "user_id", "email", "created_at", "updated_at", "deleted_at") SELECT "id", "household_id", "user_id", NULL, "created_at", "updated_at", "deleted_at" FROM `household_members`;--> statement-breakpoint
